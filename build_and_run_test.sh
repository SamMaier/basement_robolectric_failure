...
javac -d $DIR -cp $DIR/target/dependency/"*" $DIR/SimpleTest.java && java -cp $DIR:$DIR/target/specialcases/*:$DIR/target/dependency/* org.junit.runner.JUnitCore smaier.SimpleTest
